...
//! use gd32vf103xx_hal_nyaa::afio::AfioExt;
//! use gd32vf103xx_hal_nyaa::gpio::GpioExt;
//! use gd32vf103xx_hal_nyaa::serial::{Config, Serial};
//! use gd32vf103xx_hal_nyaa::time::U32Ext;
//! # fn create_serial(mut rcu: gd32vf103xx_hal_nyaa::rcu::Rcu) {
